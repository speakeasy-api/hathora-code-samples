...
export class LobbyV3SDK extends ClientSDK {
    ...
    async createLobby(
        ...
        const payload$ = schemas$.parse(
            input,
            (value$) => models.CreateLobbyRequest$.outboundSchema.parse(value$),
        ...
        if (this.matchResponse(response, 201, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return models.CreateLobbyResponse$.inboundSchema.parse({
                        ...responseFields$,
                        LobbyV3: val$,
                    });
                },
    ...
    async getLobbyInfoByRoomId(
        ...
        const input$: models.GetLobbyInfoByRoomIdRequest = {
            roomId: roomId,
            appId: appId,
        };
        const headers$ = new Headers();
        ...
        const payload$ = schemas$.parse(
            input$,
            (value$) => models.GetLobbyInfoByRoomIdRequest$.outboundSchema.parse(value$),
            "Input validation failed"
        );
        const body$ = null;
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return models.GetLobbyInfoByRoomIdResponse$.inboundSchema.parse({
                        ...responseFields$,
                        LobbyV3: val$,
                    });
                },
    ...
    async getLobbyInfoByShortCode(
        ...
        const input$: models.GetLobbyInfoByShortCodeRequest = {
            shortCode: shortCode,
            appId: appId,
        };
        const headers$ = new Headers();
        ...
        const payload$ = schemas$.parse(
            input$,
            (value$) => models.GetLobbyInfoByShortCodeRequest$.outboundSchema.parse(value$),
            "Input validation failed"
        );
        const body$ = null;
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return models.GetLobbyInfoByShortCodeResponse$.inboundSchema.parse({
                        ...responseFields$,
                        LobbyV3: val$,
                    });
                },
    ...
    async listActivePublicLobbies(
        ...
        const input$: models.ListActivePublicLobbiesRequest = {
            appId: appId,
            region: region,
        };
        const headers$ = new Headers();
        ...
        const payload$ = schemas$.parse(
            input$,
            (value$) => models.ListActivePublicLobbiesRequest$.outboundSchema.parse(value$),
            "Input validation failed"
        );
        const body$ = null;
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return models.ListActivePublicLobbiesResponse$.inboundSchema.parse({
                        ...responseFields$,
                        classes: val$,
                    });
                },
