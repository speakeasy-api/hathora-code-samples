    ...
    async createLobby(
        ...
        if (this.matchResponse(response, 201, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.CreateLobbyResponse$.inboundSchema.parse({
                        ...responseFields$,
                        LobbyV3: val$,
                    });
                },
    ...
    async listActivePublicLobbies(
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.ListActivePublicLobbiesResponse$.inboundSchema.parse({
                        ...responseFields$,
                        LobbyV3s: val$,
                    });
                },
    ...
    async getLobbyInfoByRoomId(
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.GetLobbyInfoByRoomIdResponse$.inboundSchema.parse({
                        ...responseFields$,
                        LobbyV3: val$,
                    });
                },
    ...
    async getLobbyInfoByShortCode(
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.GetLobbyInfoByShortCodeResponse$.inboundSchema.parse({
                        ...responseFields$,
                        LobbyV3: val$,
                    });
                },
