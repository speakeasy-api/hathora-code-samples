...
export class RoomV2 extends ClientSDK {
    ...
    async createRoom(
        ...
        const payload$ = schemas$.parse(
            input$,
            (value$) => models.CreateRoomRequest$.outboundSchema.parse(value$),
        ...
        if (this.matchResponse(response, 201, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return models.CreateRoomResponse1$.inboundSchema.parse({
                        ...responseFields$,
                        CreateRoomResponse: val$,
                    });
                },
    ...
    async destroyRoom(
        ...
        const input$: models.DestroyRoomRequest = {
            roomId: roomId,
            appId: appId,
        };
        const headers$ = new Headers();
        ...
        const payload$ = schemas$.parse(
            input$,
            (value$) => models.DestroyRoomRequest$.outboundSchema.parse(value$),
            "Input validation failed"
        );
        const body$ = null;
        ...
        return schemas$.parse(
            undefined,
            () => models.DestroyRoomResponse$.inboundSchema.parse(responseFields$),
            "Response validation failed"
        );
    }
    ...
    async getActiveRoomsForProcess(
        ...
        const input$: models.GetActiveRoomsForProcessRequest = {
            processId: processId,
            appId: appId,
        };
        const headers$ = new Headers();
        ...
        const payload$ = schemas$.parse(
            input$,
            (value$) => models.GetActiveRoomsForProcessRequest$.outboundSchema.parse(value$),
            "Input validation failed"
        );
        const body$ = null;
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return models.GetActiveRoomsForProcessResponse$.inboundSchema.parse({
                        ...responseFields$,
                        classes: val$,
                    });
                },
    ...
    async getConnectionInfo(
        ...
        const input$: models.GetConnectionInfoRequest = {
            roomId: roomId,
            appId: appId,
        };
        const headers$ = new Headers();
        ...
        const payload$ = schemas$.parse(
            input$,
            (value$) => models.GetConnectionInfoRequest$.outboundSchema.parse(value$),
            "Input validation failed"
        );
        const body$ = null;
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return models.GetConnectionInfoResponse$.inboundSchema.parse({
                        ...responseFields$,
                        ConnectionInfoV2: val$,
                    });
                },
                "Response validation failed"
            );
    ...
    async getInactiveRoomsForProcess(
        ...
        const input$: models.GetInactiveRoomsForProcessRequest = {
            processId: processId,
            appId: appId,
        };
        const headers$ = new Headers();
        ...
        const payload$ = schemas$.parse(
            input$,
            (value$) => models.GetInactiveRoomsForProcessRequest$.outboundSchema.parse(value$),
            "Input validation failed"
        );
        const body$ = null;
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return models.GetInactiveRoomsForProcessResponse$.inboundSchema.parse({
                        ...responseFields$,
                        classes: val$,
                    });
                },
    ...
    async getRoomInfo(
        ...
        const input$: models.GetRoomInfoRequest = {
            roomId: roomId,
            appId: appId,
        };
        const headers$ = new Headers();
        ...
        const payload$ = schemas$.parse(
            input$,
            (value$) => models.GetRoomInfoRequest$.outboundSchema.parse(value$),
            "Input validation failed"
        );
        const body$ = null;
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return models.GetRoomInfoResponse$.inboundSchema.parse({
                        ...responseFields$,
                        Room: val$,
                    });
                },
    ...
    async suspendRoom(
        ...
        const input$: models.SuspendRoomRequest = {
            roomId: roomId,
            appId: appId,
        };
        const headers$ = new Headers();
        ...
        const payload$ = schemas$.parse(
            input$,
            (value$) => models.SuspendRoomRequest$.outboundSchema.parse(value$),
            "Input validation failed"
        );
        const body$ = null;
        ...
        return schemas$.parse(
            undefined,
            () => models.SuspendRoomResponse$.inboundSchema.parse(responseFields$),
            "Response validation failed"
        );
    }
    ...
    async updateRoomConfig(
        ...
        const payload$ = schemas$.parse(
            input$,
            (value$) => models.UpdateRoomConfigRequest$.outboundSchema.parse(value$),
            "Input validation failed"
        );
        ...
        return schemas$.parse(
            undefined,
            () => models.UpdateRoomConfigResponse$.inboundSchema.parse(responseFields$),
            "Response validation failed"
        );
    }
}
