...
public class CreateProcessResponse implements dev.hathora.cloud_api.utils.Response {
    ...
    public CreateProcessResponse withApiError(dev.hathora.cloud_api.models.shared.ApiError apiError) {
        Utils.checkNotNull(apiError, "apiError");
        this.apiError = Optional.ofNullable(apiError);
        return this;
    }

    public CreateProcessResponse withApiError(Optional<? extends dev.hathora.cloud_api.models.shared.ApiError> apiError) {
        Utils.checkNotNull(apiError, "apiError");
        this.apiError = apiError;
        return this;
    }
    ...
    public CreateProcessResponse withProcessV2(dev.hathora.cloud_api.models.shared.ProcessV2 processV2) {
        Utils.checkNotNull(processV2, "processV2");
        this.processV2 = Optional.ofNullable(processV2);
        return this;
    }

    public CreateProcessResponse withProcessV2(Optional<? extends dev.hathora.cloud_api.models.shared.ProcessV2> processV2) {
        Utils.checkNotNull(processV2, "processV2");
        this.processV2 = processV2;
        return this;
    }
