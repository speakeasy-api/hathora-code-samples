...
/**
 * ApplicationWithLatestDeploymentAndBuildDeployment - Deployment is a versioned configuration for a build that describes runtime behavior.
 */

public class ApplicationWithLatestDeploymentAndBuildDeployment {
     ...
     */
    @JsonProperty("env")
    private java.util.List<ApplicationWithLatestDeploymentAndBuildEnv> env;
    ...
    @Deprecated
    private ApplicationWithLatestDeploymentAndBuildTransportType transportType;

    public ApplicationWithLatestDeploymentAndBuildDeployment(
            ...
            @JsonProperty("env") java.util.List<ApplicationWithLatestDeploymentAndBuildEnv> env,
            ...
            @JsonProperty("transportType") ApplicationWithLatestDeploymentAndBuildTransportType transportType) {
     ...
     * The environment variable that our process will have access to at runtime.
     */
    public java.util.List<ApplicationWithLatestDeploymentAndBuildEnv> env() {
        return env;
    }
     ...
     */
    @Deprecated
    public ApplicationWithLatestDeploymentAndBuildTransportType transportType() {
     ...
     * Additional ports your server listens on.
     */
    public ApplicationWithLatestDeploymentAndBuildDeployment withAdditionalContainerPorts(java.util.List<ContainerPort> additionalContainerPorts) {
        Utils.checkNotNull(additionalContainerPorts, "additionalContainerPorts");
        this.additionalContainerPorts = additionalContainerPorts;
        return this;
    }
     ...
     * System generated unique identifier for an application.
     */
    public ApplicationWithLatestDeploymentAndBuildDeployment withAppId(String appId) {
        Utils.checkNotNull(appId, "appId");
        this.appId = appId;
        return this;
    }
     ...
     * A build represents a game server artifact and its associated metadata.
     */
    public ApplicationWithLatestDeploymentAndBuildDeployment withBuild(Build build) {
        Utils.checkNotNull(build, "build");
        this.build = build;
        return this;
    }
     ...
     * System generated id for a build. Increments by 1.
     */
    public ApplicationWithLatestDeploymentAndBuildDeployment withBuildId(int buildId) {
        Utils.checkNotNull(buildId, "buildId");
        this.buildId = buildId;
        return this;
    }
     ...
     */
    @Deprecated
    public ApplicationWithLatestDeploymentAndBuildDeployment withContainerPort(double containerPort) {
        Utils.checkNotNull(containerPort, "containerPort");
        this.containerPort = containerPort;
        return this;
    }
     ...
     * When the deployment was created.
     */
    public ApplicationWithLatestDeploymentAndBuildDeployment withCreatedAt(OffsetDateTime createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * A container port object represents the transport configruations for how your server will listen.
     */
    public ApplicationWithLatestDeploymentAndBuildDeployment withDefaultContainerPort(ContainerPort defaultContainerPort) {
        Utils.checkNotNull(defaultContainerPort, "defaultContainerPort");
        this.defaultContainerPort = defaultContainerPort;
        return this;
    }
     ...
     * System generated id for a deployment. Increments by 1.
     */
    public ApplicationWithLatestDeploymentAndBuildDeployment withDeploymentId(int deploymentId) {
        Utils.checkNotNull(deploymentId, "deploymentId");
        this.deploymentId = deploymentId;
        return this;
    }
     ...
     * The environment variable that our process will have access to at runtime.
     */
    public ApplicationWithLatestDeploymentAndBuildDeployment withEnv(java.util.List<ApplicationWithLatestDeploymentAndBuildEnv> env) {
        Utils.checkNotNull(env, "env");
        this.env = env;
        return this;
    }
     ...
     * for five minutes.
     */
    public ApplicationWithLatestDeploymentAndBuildDeployment withIdleTimeoutEnabled(boolean idleTimeoutEnabled) {
        Utils.checkNotNull(idleTimeoutEnabled, "idleTimeoutEnabled");
     ...
     * for five minutes.
     */
    public ApplicationWithLatestDeploymentAndBuildDeployment withIdleTimeoutEnabled(Optional<? extends Boolean> idleTimeoutEnabled) {
        Utils.checkNotNull(idleTimeoutEnabled, "idleTimeoutEnabled");
        this.idleTimeoutEnabled = idleTimeoutEnabled;
        return this;
    }
     ...
     * `large`: 4 core, 8gb memory
     */
    public ApplicationWithLatestDeploymentAndBuildDeployment withPlanName(PlanName planName) {
        Utils.checkNotNull(planName, "planName");
        this.planName = planName;
        return this;
    }
     ...
     * The number of cores allocated to your process.
     */
    public ApplicationWithLatestDeploymentAndBuildDeployment withRequestedCPU(double requestedCPU) {
        Utils.checkNotNull(requestedCPU, "requestedCPU");
        this.requestedCPU = requestedCPU;
        return this;
    }
     ...
     * The amount of memory allocated to your process.
     */
    public ApplicationWithLatestDeploymentAndBuildDeployment withRequestedMemoryMB(int requestedMemoryMB) {
        Utils.checkNotNull(requestedMemoryMB, "requestedMemoryMB");
        this.requestedMemoryMB = requestedMemoryMB;
        return this;
    }
     ...
     * Governs how many [rooms](https://hathora.dev/docs/concepts/hathora-entities#room) can be scheduled in a process.
     */
    public ApplicationWithLatestDeploymentAndBuildDeployment withRoomsPerProcess(int roomsPerProcess) {
        Utils.checkNotNull(roomsPerProcess, "roomsPerProcess");
        this.roomsPerProcess = roomsPerProcess;
        return this;
    }
     ...
     */
    @Deprecated
    public ApplicationWithLatestDeploymentAndBuildDeployment withTransportType(ApplicationWithLatestDeploymentAndBuildTransportType transportType) {
        Utils.checkNotNull(transportType, "transportType");
        this.transportType = transportType;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ApplicationWithLatestDeploymentAndBuildDeployment other = (ApplicationWithLatestDeploymentAndBuildDeployment) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ApplicationWithLatestDeploymentAndBuildDeployment.class,
    ...
    public final static class Builder {
         ...
         * The environment variable that our process will have access to at runtime.
         */
        public Builder env(java.util.List<ApplicationWithLatestDeploymentAndBuildEnv> env) {
            Utils.checkNotNull(env, "env");
            this.env = env;
            return this;
        }
         ...
         */
        @Deprecated
        public Builder transportType(ApplicationWithLatestDeploymentAndBuildTransportType transportType) {
            Utils.checkNotNull(transportType, "transportType");
            this.transportType = transportType;
            return this;
        }
        
        public ApplicationWithLatestDeploymentAndBuildDeployment build() {
            if (idleTimeoutEnabled == null) {
                idleTimeoutEnabled = _SINGLETON_VALUE_IdleTimeoutEnabled.value();
            }
            return new ApplicationWithLatestDeploymentAndBuildDeployment(
                additionalContainerPorts,
                appId,
                build,
                buildId,
