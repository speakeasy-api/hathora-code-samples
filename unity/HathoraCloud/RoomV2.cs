...
namespace HathoraCloud
{
    ...
    public interface IRoomV2
    {
        ...
        /// </summary>
        Task<SuspendRoomResponse> SuspendRoomAsync(SuspendRoomRequest request);
    ...
    public class RoomV2: IRoomV2
    {
        ...
        public async Task<SuspendRoomResponse> SuspendRoomAsync(SuspendRoomRequest request)
        {
            if (request == null)
            {
                request = new SuspendRoomRequest();
            }
            request.AppId ??= SDKConfiguration.AppId;
